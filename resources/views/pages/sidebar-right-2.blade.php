  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter first"> 
        ...
        <img class="imgr borderedbox" src="../{{ asset('academic-education/images/demo/120x120.gif')}}" alt="">
        <p>Aliquatjusto quisque nam consequat doloreet vest orna partur scetur portortis nam. Metadipiscing eget facilis elit sagittis felisi eger id justo maurisus convallicitur.</p>
        <p>Dapiensociis <a href="#">temper donec auctortortis cumsan</a> et curabitur condis lorem loborttis leo. Ipsumcommodo libero nunc at in velis tincidunt pellentum tincidunt vel lorem.</p>
        <img class="imgl borderedbox" src="../{{ asset('academic-education/images/demo/120x120.gif')}}" alt="">
        ...
        <div id="comments">
          ...
          <ul>
            <li>
              <article>
                <header>
                  <figure class="avatar"><img src="../{{ asset('academic-education/images/demo/avatar.png')}}" alt=""></figure>
                  <address>
                  By <a href="#">A Name</a>
                  </address>
